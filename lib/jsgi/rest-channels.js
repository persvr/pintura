...
//var cometWorker = new (require("worker").SharedWorker)("comet-worker", "comet-worker"); 
/**
 * Comet JSGI app factory that allows data to be sent to clients
 */
var Comet = exports.Comet = function(options){
	return function(env){
...
exports.Channels= function(nextApp, options /*subscribe, serializer, path*/){
	var path = (options && options.path) || "/channels";
	var serializer = (options && options.serializer) || JSON.stringify;
