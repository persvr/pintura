...
//dir('MODEL0', model, path, Object.keys(model));
				}
				else{
//dir('MODEL1', model, path, Object.keys(model));
					if(model[path]){
						//path += '/'; continue;
...
//dir('MODEL!!!', model, method, metadata);
request.getModel = function(){return model.properties;}
