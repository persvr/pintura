...
exports.Session = function(options, nextApp){
	...
	return function(request){
		var newSessionId, expiration, session;
		request.getSession = function(createIfNecessary, expires){
			...
			if (cookieId) {
				...
				return session = exports.getSessionModel().get(cookieId);
				...
				// TODO: use add()
				return session = exports.getSessionModel().put({
...
exports.SessionProperty = function(nextApp, store, createIfNecessary){
	return exports.Session(function(request){
		return when(request.getSession(createIfNecessary), function(session){
			request.session = session;
