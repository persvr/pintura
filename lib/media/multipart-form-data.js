...
/*
	...
	if(!exports.fileStore){
		...
		exports.fileStore = require("../persisted").DefaultStoreConstructor("File");
	}
	if(!exports.FileClass){
		exports.FileClass = require("../persisted").Class("File", exports.fileStore, {
			get: function(id){
				var object = exports.fileStore.get(id);
				object["representation:" + object.contentType] = {
					serialize: function(){
						return "file";
					},
					getQuality: function(){
	...
	exports.FileClass.create(fileObject);
	return fileObject;
	*/