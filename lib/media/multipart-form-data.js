...
/*
	...
	if(!exports.fileStore){
		...
		exports.fileStore = require("stores").openObjectStore("File");
	}
	exports.fileStore.create(fileObject);
	return fileObject;
	*/

/** This is taken directly from Node.js and modified for JSGI forEachable streams*/
