...
var QueryString = exports.QueryString = function(string, params){
	this.string = string;
	this.params = params;
};
...
["charAt", "toString", "valueOf"].forEach(function(i){
...
QueryString.prototype.match = function(regexp){
	var matches = String.prototype.match.call(this.string, QueryRegExp(regexp));
	if(matches){
		matches.forEach(function(str, i){
			matches[i] = str && new QueryString(str);
		});
	}
	return matches;
};
QueryString.prototype.replace = function(regexp, newStr){
	...
	return new QueryString(String.prototype.replace.call(this.string, QueryRegExp(regexp), newStr));
};
...
var remoteRequest = function(method, url, body, start, end){
...
// persevere edit
exports.jsonQuery = function(/*String*/query, args){// persevere edit
	// summary:
