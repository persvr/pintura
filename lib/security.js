...
//DVV			return when(userClass.query("username=$1", {
//DVV				parameters: [username]
//DVV			}), function(results){
			return when(security.getUserClass().query("eq(username,"+username+")"), function(results){
